...
using System.Data.Common; // Include this namespace
using System.Threading.Tasks; // Include this namespace
using Models;
using System.Data;
        ...
        public async Task<List<Producto>> ObtenerProductosAsync()
        {
            ...
            try
            {
                using (MySqlConnection conexion = DatabaseConnectionManager.GetConnection())
                {
                    ...
                    // Adjust the SQL query to select product details
                        ...
                        using (DbDataReader lector = await comando.ExecuteReaderAsync())
                        {
                            while (await lector.ReadAsync())
                            {
                                Producto producto = new Producto
                                {
                                    ...
                                    Cantidad = 0, // Initialize as needed
